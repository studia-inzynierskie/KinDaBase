...
ALTER TABLE movies_categories
    ADD CONSTRAINT movies_categories_categories_fk FOREIGN KEY ( category_id )
        REFERENCES categories ( category_id );

ALTER TABLE movies_categories
    ADD CONSTRAINT movies_categories_movies_fk FOREIGN KEY ( movie_id )
        REFERENCES movies ( movie_id );
...
ALTER TABLE series_categories
    ADD CONSTRAINT series_categories_categories_fk FOREIGN KEY ( category_id )
        REFERENCES categories ( category_id );

ALTER TABLE series_categories
    ADD CONSTRAINT series_categories_series_fk FOREIGN KEY ( series_id )
        REFERENCES series ( series_id );

...
INSERT INTO SERIES (SERIES_ID, NAME, RATING, STARTS_DATE, ENDS_DATE, DESCRIPTION, COUNTRY, SEASONS) 
VALUES (7, 'Dexter', 8.2, to_date('2006', 'RRRR'), to_date('RRRR'), 'Dexter prowadzi podwójne ¿ycie. Za dnia jest cenionym specjalist¹ ds. krwi w departamencie policji, a noc¹ zabija z³oczyñców, którzy wymykaj¹ siê organom sprawiedliwoœci.', 'USA', 8);

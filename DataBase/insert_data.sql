...
VALUES ('Leonardo', 'DiCaprio', 1.34, to_date('07/12/1974', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Johny', 'Depp', 5.52, to_date('04/15/1947', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Brad', 'Pitt', 7.27, to_date('05/30/1963', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Robert', 'DeNiro', 8.91, to_date('09/27/1973', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Samuel', 'L.Jackson', 4.50, to_date('07/12/1974', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Tom', 'Hanks', 1.04, to_date('04/15/1947', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Meryl', 'Streep', 9.95, to_date('05/31/1963', 'MM/DD/RRRR'), 'K');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Morgan', 'Freeman', 1.80, to_date('09/27/1973', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Anthony ', 'Hopkins', 1.02, to_date('07/21/1978', 'MM/DD/RRRR'), 'M');

INSERT INTO ACTORS (NAME, SURNAME, RATING, BIRTH_DATE, SEX) 
VALUES ('Cezary', '¯ak', 9.78, to_date('08/15/1976', 'MM/DD/RRRR'), 'M');
